		...
		<!-- //header-ends -->
					...
					<!--//pop-up-box -->
						...
						<div class="browse">
								<div class="tittle-head two">
									<h3 class="tittle">All Artists <span class="new">New</span></h3>
									<div class="clearfix"> </div>
								</div>
            ...
            <%
                    ...
                    try
                    {
                        ...
                        resultset =statement.executeQuery("select DISTINCT artist from categorya") ;
                        while(resultset.next())
                      	{
            %>

            <div class="col-md-3 artist-grid">
            <a href="artist.jsp?artist=<%=resultset.getString(1)%>&&name=<%=name%>&&id=<%=id%>" onclick="location.href=this.href+;return false;"><img src="images/music.jpg" title="allbum-name"></a>
            <a href="artist.jsp?artist=<%=resultset.getString(1)%>&&name=<%=name%>&&id=<%=id%>" onclick="location.href=this.href;return false;"><i class="glyphicon glyphicon-play-circle"></i></a>
            <a class="art" href="artist.jsp?artist=<%=resultset.getString(1)%>&&name=<%=name%>&&id=<%=id%>" onclick="location.href=this.href;return false;"><%out.print(resultset.getString(1));%></a>
            </div>
